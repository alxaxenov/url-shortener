...
func (_m *MockWriter) Write(_a0 []byte) (int, error) {
	ret := _m.Called(_a0)
...
//   - _a0 []byte
func (_e *MockWriter_Expecter) Write(_a0 interface{}) *MockWriter_Write_Call {
	return &MockWriter_Write_Call{Call: _e.mock.On("Write", _a0)}
}

func (_c *MockWriter_Write_Call) Run(run func(_a0 []byte)) *MockWriter_Write_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte))
	})
	return _c
...
func (_c *MockWriter_Write_Call) Return(_a0 int, _a1 error) *MockWriter_Write_Call {
